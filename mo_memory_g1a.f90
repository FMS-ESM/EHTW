...
CONTAINS
  ...
  SUBROUTINE construct_g1a (lnlon, lnlev, lntrac, lngl, &
    ...
    CALL add_stream_element (g1a, 'vom1',    vom1,    dim1p,dim1,dimnames=dim1n,longname='? (t-dt)',units='?')
    CALL add_stream_element (g1a, 'dm1',     dm1,     dim1p,dim1,dimnames=dim1n,longname='? (t-dt)',units='?')
    CALL add_stream_element (g1a, 'tm1',     tm1,     dim1p,dim1,dimnames=dim1n,longname='temperature (t-dt)',units='K?')
    CALL add_stream_element (g1a, 'alpsm1',  alpsm1,  dim2p,dim2,dimnames=dim2n,longname='? (t-dt)',units='?')
    CALL add_stream_element (g1a, 'dalpslm1',dalpslm1,dim2p,dim2,dimnames=dim2n,longname='? (t-dt)',units='?')
    CALL add_stream_element (g1a, 'dalpsmm1',dalpsmm1,dim2p,dim2,dimnames=dim2n,longname='? (t-dt)',units='?')
    CALL add_stream_element (g1a, 'qm1',     qm1,     dim1p,dim1,dimnames=dim1n,longname='humidity (t-dt)',units='kg/kg?')
    CALL add_stream_element (g1a, 'xlm1',    xlm1,    dim1p,dim1,dimnames=dim1n,longname='cloud water (t-dt)',units='kg/kg?')
    CALL add_stream_element (g1a, 'xim1',    xim1,    dim1p,dim1,dimnames=dim1n,longname='cloud ice (t-dt)',units='kg/kg?')
    !
