...
CONTAINS
  ...
  SUBROUTINE init_ghg
    ...
    IF (p_parallel_io) THEN 
      ghg%opened=.FALSE.
    ! select scenario
      IF(ighg == 1) CALL IO_open('greenhouse_rcp26.nc', ghg, IO_READ)
      IF(ighg == 2) CALL IO_open('greenhouse_rcp45.nc', ghg, IO_READ)
      IF(ighg == 3) CALL IO_open('greenhouse_rcp85.nc', ghg, IO_READ)
      IF(ighg == 4) CALL IO_open('millennium_gases_A1B.nc', ghg, IO_READ)
